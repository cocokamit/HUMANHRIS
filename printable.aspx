<%@ Page Language="C#" AutoEventWireup="true" CodeFile="printable.aspx.cs" Inherits="printable" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Ratings" ItemStyle-Font-Size="11px" ItemStyle-CssClass="ssst"  ><%--ItemStyle-CssClass="hideGridColumn" HeaderStyle-CssClass="hideGridColumn"--%>
                                            <ItemTemplate >
                                                ...
                                                <asp:RadioButtonList ID="rdiorate" CssClass="flo" runat="server"> </asp:RadioButtonList></td>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                    </asp:GridView>
