<%@ Page Title="" Language="C#" MasterPageFile="~/content/site.master" AutoEventWireup="true" CodeFile="attendance.aspx.cs" Inherits="content_GM_attendance" %>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
                ...
                <asp:DropDownList ID="ddl_depart" ClientIDMode="Static" CssClass="select2" runat="server"  AutoPostBack="true" OnSelectedIndexChanged="OnChangeDepart" style="float:left !important; width:300px" >
                </asp:DropDownList>

                <asp:DropDownList ID="ddl_section" ClientIDMode="Static" CssClass="select2" runat="server"  AutoPostBack="true" OnSelectedIndexChanged="OnChangeFilter" style="float:left !important; width:300px" >
                </asp:DropDownList>
