<%@ Page Language="C#" AutoEventWireup="true" CodeFile="approve_preovertime.aspx.cs" Inherits="content_Manager_approve_preovertime" MasterPageFile="~/content/site.master"%>
...
<section class="content-header">
    <h1>Pre Overtime Approval</h1>
    <ol class="breadcrumb">
    <li><a href="dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
    <li class="active">Pre-Overtime Approval</li>
    </ol>
</section>
                ...
                <asp:Label ID="lbl_del_notify" runat="server" style=" position:absolute; right:0; margin-top:-25px; font-size:11px; "></asp:Label>
                 <asp:GridView ID="grid_view" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered no-margin">
                    <Columns>
                        ...
                        <asp:BoundField DataField="OTDate" HeaderText="Date Overtime"/>
                        <asp:BoundField DataField="FullName" HeaderText="Employee Name"/>
                        <asp:BoundField DataField="OTStart" HeaderText="Time In"/>
                        <asp:BoundField DataField="OTEnd" HeaderText="Time Out"/>
