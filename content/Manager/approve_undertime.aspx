<%@ Page Language="C#" AutoEventWireup="true" CodeFile="approve_undertime.aspx.cs" Inherits="content_Manager_approve_undertime" MasterPageFile="~/content/site.master"  %>
...
<script type="text/javascript">
    ...
    function Confirm_a() {
        var confirm_value = document.getElementById("<%= TextBox1.ClientID %>")
        if (confirm("Are you sure you want to approved this undertime request?"))
        { confirm_value.value = "Yes"; } else { confirm_value.value = "No"; }
    }
...
<section class="content-header">
    <h1>Undertime Approval</h1>
    <ol class="breadcrumb">
    <li><a href="dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
    <li class="active">Undertime Approval</li>
    </ol>
</section>
           ...
           <div class="box-header">
            ...
            <asp:GridView ID="grid_view" runat="server" AutoGenerateColumns="false" EmptyDataText="No record found"  CssClass="table table-striped table-bordered no-margin">
                        <Columns>
                            ...
                            <asp:BoundField DataField="date_filed" HeaderText="Date Undertime"/>
