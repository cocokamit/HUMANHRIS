<%@ Page Language="C#" AutoEventWireup="true" CodeFile="approve_rest.aspx.cs" Inherits="content_Manager_approve_rest" MasterPageFile="~/content/site.master" %>
...
<section class="content-header">
    <h1>Rest Day Approval</h1>
    <ol class="breadcrumb">
    <li><a href="dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
    <li class="active">Rest Day Approval</li>
    </ol>
</section>
              ...
              <asp:GridView ID="grid_view" runat="server" AutoGenerateColumns="false" EmptyDataText="No record found" CssClass="table table-striped table-bordered no-margin">
                <Columns>
                    ...
                    <asp:BoundField DataField="nxt_id" HeaderText="" ItemStyle-CssClass="none" HeaderStyle-CssClass="none"/>  
                      <asp:BoundField DataField="emp_id" HeaderText="" ItemStyle-CssClass="none" HeaderStyle-CssClass="none"/>    
