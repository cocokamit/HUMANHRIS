<%@ Page Language="C#" AutoEventWireup="true" CodeFile="schedule_h.aspx.cs" Inherits="content_Manager_schedule_h" MasterPageFile="~/content/site.master" %>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            ...
            <div class="x-head" style=" display:none;">
            ...
            <div class="x_content overflow" style="overflow:scroll;">
            ...
            <asp:Panel ID="p_footer" runat="server" style=" display:none;">
