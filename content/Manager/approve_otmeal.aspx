<%@ Page Language="C#" AutoEventWireup="true" CodeFile="approve_otmeal.aspx.cs" Inherits="content_Manager_approve_otmeal" MasterPageFile="~/content/site.master"%>
...
<script type="text/javascript">
    ...
    function Confirm() {
        var confirm_value = document.getElementById("<%= TextBox1.ClientID %>")
        if (confirm("Are you sure to approved this application?"))
        { confirm_value.value = "Yes"; } else { confirm_value.value = "No"; }
    }
...
<section class="content-header">
    <h1>OT Meal Approval</h1>
    <ol class="breadcrumb">
    <li><a href="dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
    <li class="active">Meal Approval</li>
    </ol>
</section>
          ...
          <div class="box box-primary">
             <div class="box-header">
                ...
                <div id="div_action" runat="server" class="input-group pull-right">
                    <asp:LinkButton runat="server" OnClick="delete_all" ID="ib_del" CssClass="btn btn-default" style="margin-right:5px;float:left;"  ToolTip="Delete"><i class="fa fa-trash border-right"></i></asp:LinkButton>
                    <asp:LinkButton runat="server" OnClick="approve_all" ID="ib_app" CssClass="btn btn-default" style="float:left;"  ToolTip="Approve"><i class="fa fa-thumbs-o-up"></i></asp:LinkButton>
                </div>
            </div>
                ...
                <div id="alert" runat="server" class="alert alert-default alert-dismissible">
                 ...
                 <asp:GridView ID="grid_view" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered no-margin">
                    <Columns>
                        ...
                        <asp:BoundField DataField="OTMDate" HeaderText="Date"/>
                        ...
                        <asp:BoundField DataField="othrs" HeaderText="OT Hours"/>
