<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dtr_employee.aspx.cs" Inherits="content_Manager_dtr_employee" MasterPageFile="~/content/site.master" %>
          ...
          <div class="box box-primary">
            <div class="box-header">
                <div class="input-group">
                    <asp:DropDownList ID="drop_emp" ClientIDMode="Static" CssClass="select pull-left" style="margin-right:5px" Width="200px" runat="server" ></asp:DropDownList>
                     <asp:DropDownList ID="ddl_pay_range" CssClass="select2" runat="server"></asp:DropDownList>
