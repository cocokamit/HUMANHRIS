...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x-head">
                <asp:TextBox ID="txt_from" cssclass="datee" placeholder="From" runat="server" autocomplete="off"></asp:TextBox>
                <asp:TextBox ID="txt_to" cssclass="datee"  placeholder="To" runat="server"  autocomplete="off"></asp:TextBox>
                <asp:DropDownList ID="dl_choice" Height="37px" runat="server" AutoPostBack="true" OnSelectedIndexChanged="change_choice" CssClass="minimal">
            ...
            <div id="alert" runat="server" class="alert alert-empty">
             ...
             <asp:GridView ID="grid_CS" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered no-margin">
                <Columns>
                    <asp:BoundField DataField="id" ItemStyle-CssClass="none" HeaderStyle-CssClass="none"/>
                    <asp:BoundField DataField="TCSID" ItemStyle-CssClass="none" HeaderStyle-CssClass="none"/>
