<%@ Page Language="C#" AutoEventWireup="true" CodeFile="scpayslip.aspx.cs" Inherits="content_printable_scpayslip" %>
...
<body>
    ...
    <div class="content">
    <%
        string query = "select  b.LastName+', '+b.FirstName+' '+b.MiddleName c_name,a.grossamt,a.wht,a.net , left(convert(varchar,c.dfrom,101),10)DateStart,left(convert(varchar,c.dtoo,101),10)DateEnd ,    " +
                       "case when b.payrolltypeid=1 then b.MonthlyRate else b.DailyRate end rate,i.company,b.taxtable, " +
                        "e.TaxCode, " +
                        "g.Department, " +
                        "h.Position " +
                        "from sc_trn_details a left join memployee b on a.empid=b.Id " +
                        "left join sc_transaction c on a.sctrnid=c.sctrnid " +
                        ...
                        if (Request.QueryString["b"].ToString() == "single")
                           query += "a.empid=" + empid + " and a.sctrnid=" + payid + " ";
                        else 
                           query += "a.sctrnid=" + payid + " ";
