...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div id="xp"  class="x_panel">
            <ul class="pre left">
                <li>Payroll Group</li>
                <li><asp:DropDownList ID="ddl_pg" OnSelectedIndexChanged="verify_det" AutoPostBack="true" runat="server"></asp:DropDownList></li>
                <li>DTR</li>
                <li><asp:DropDownList ID="ddl_dtr" Enabled="false" runat="server" ></asp:DropDownList></li>
            </ul>
            <ul class="pre left">
                 <li>Other Income</li>
                <li><asp:DropDownList ID="ddl_otherincome" Enabled="false" runat="server" ></asp:DropDownList></li>
                <li>Other Deduction</li>
                <li><asp:DropDownList ID="ddl_otherdeduction" Enabled="false" runat="server" ></asp:DropDownList></li>
            </ul>
