<%@ Page Language="C#" AutoEventWireup="true" CodeFile="thirteendetails.aspx.cs" Inherits="content_payroll_thirteendetails" %>
        ...
        <asp:GridView ID="grid_view" runat="server" AutoGenerateColumns="false" CssClass="Grid">
                    <Columns>
                        <asp:BoundField DataField="empid" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"/>
                          <asp:BoundField DataField="tmtrnid" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"/>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton1" runat="server" ToolTip="Click to view payslip." OnClick="viewpayslip"  Text="view"   style=" margin:3px;" ></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
