<%@ Page Title="" Language="C#" MasterPageFile="~/content/site.master" AutoEventWireup="true" CodeFile="attendance.aspx.cs" Inherits="content_HOD_attendance" %>
...
<link href="vendors/select2/dist/css/select2.css" rel="stylesheet" type="text/css" />
    <style type="text/css">
        ...
        .danger { background:#dd4b39 !important; color: #fff !important}
        .restday {background: #16b7df !important; color: #fff !important}
        .yellow {background: #d8ce5d !important; color: #fff !important}
        .orange {background: #f39c12   !important; color: #fff !important}
        .leave {background: #3c8dbc !important; color: #fff !important}
        .holiday {background: #d81b60    !important; color: #fff !important}
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
                ...
                <asp:DropDownList ID="ddl_section" ClientIDMode="Static" CssClass="select2" runat="server"  AutoPostBack="true" OnSelectedIndexChanged="OnChangeFilter" style="float:left !important; width:180px" >
                </asp:DropDownList>
