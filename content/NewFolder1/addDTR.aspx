<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addDTR.aspx.cs" Inherits="content_NewFolder1_DTR" MasterPageFile="~/content/MasterPageNew.master" %>
        ...
        <div id="xp" class="x_panel">
            <div class="x-head">
              ...
              <%--<asp:TextBox ID="txt_f" runat="server" Enabled="false"  CssClass="datee" autocomplete="off" placeholder='From'></asp:TextBox>
                ...
                <input type="button" id="btngogo" onclick="getdtrgo()" value="GO" class="btn btn-primary" />
            ...
            <ul id="tbl1" runat="server" visible="false" class="pre">
              ...
              <li><input type="button" id="btnpropro" onclick="getdtr()" value="Process DTR" class="btn btn-primary" /></li>
            </ul>
           <%--  <div id="container" style="overflow: scroll; overflow-x: hidden;">
            ...
            <div>
             ...
             <asp:GridView ID="grid_item" runat="server" ClientIDMode="Static"  AutoGenerateColumns="False" CssClass="GridViewStyle">
