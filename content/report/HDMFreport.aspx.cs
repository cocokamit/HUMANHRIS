...
public partial class content_report_HDMFreport : System.Web.UI.Page
{
    ...
    {
        string query = "select Employee,department,hdmfnumber,sum(netincome)netincome,sum(ee_share)ee_share,sum(er_share)er_share,sum(ee_share+er_share) total from " +
                        "( " +
                        "select b.ID, a.lastname+', '+a.firstname+' '+a.middlename Employee,(select top 1 department from mdepartment where id=a.departmentid)department,a.hdmfnumber,c.payrollnumber,b.netincome,b.hdmfcontribution ee_share ,b.hdmfcontributionemployer er_share from memployee a " +
                        ...
                        ")phic_con group by Employee,department,hdmfnumber order by Employee,department";
