<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SSSreport.aspx.cs" Inherits="content_report_New_SSSreport" MasterPageFile="~/content/MasterPageNew.master"%>
        ...
        <% } %>
            ...
            <asp:GridView ID="grid_view" runat="server" OnPageIndexChanging="OnPageIndexChanging" AutoGenerateColumns="False" CssClass="GridViewStyle">
              <HeaderStyle  CssClass="GridViewHeaderStyle" />
               <Columns>
                <asp:BoundField DataField="SSS_ID" HeaderText="SSS ID"/>
                <asp:BoundField DataField="Employee_ID" HeaderText="ID Number"/>
                <asp:BoundField DataField="Department" HeaderText="Department"/>
                <asp:BoundField DataField="LastName" HeaderText="LastName"/>
                <asp:BoundField DataField="FirstName" HeaderText="FirstName"/>
                <asp:BoundField DataField="MiddleName" HeaderText="MiddleName"/>
                <asp:BoundField DataField="Employee_Contribution" HeaderText="Employee Contribution" DataFormatString="{0:n2}"/>
                <asp:BoundField DataField="Employer_Contribution" HeaderText="Employer Contribution" DataFormatString="{0:n5}"/>
                <asp:BoundField DataField="ee_er" HeaderText="Total EE/ER" DataFormatString="{0:n5}"/>
                <asp:BoundField DataField="ec" HeaderText="EC" DataFormatString="{0:n2}"/>
                <asp:BoundField DataField="MPF" HeaderText="MPF" DataFormatString="{0:n2}"/>
                <asp:BoundField DataField="TIN" HeaderText="TIN"/>
                <asp:BoundField DataField="Birth_Date" HeaderText="Birth Date"/>
                <asp:BoundField DataField="Total" HeaderText="Total" DataFormatString="{0:n5}"/>
               </Columns>
            </asp:GridView>
        </div>
     </div>
