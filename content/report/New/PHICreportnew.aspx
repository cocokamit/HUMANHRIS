<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PHICreportnew.aspx.cs" Inherits="content_report_New_PHICreportnew" MasterPageFile="~/content/MasterPageNew.master"%>
<%@ Import Namespace="System.Data" %>

<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
<title>Cebu LandMasters PHIC</title>
    <!-- DataTables -->
    ...
    <div class="row">
        ...
        <HeaderStyle  CssClass="GridViewHeaderStyle" />
          <Columns>
            ...
            <asp:BoundField DataField="phicnumber" HeaderText="PHIC Number"/>
