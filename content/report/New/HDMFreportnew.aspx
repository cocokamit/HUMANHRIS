<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HDMFreportnew.aspx.cs" Inherits="content_report_HDMFreportnew" MasterPageFile="~/content/MasterPageNew.master"%>
<%@ Import Namespace="System.Data" %>

<asp:Content ID="head" runat="server" ContentPlaceHolderID="head">
<title>Cebu LandMasters HDMF</title>
    <!-- DataTables -->
...
<div class="row">
  <div class="x_panel">
        ...
        <asp:DropDownList ID="ddl_year" runat="server" OnTextChanged="search" AutoPostBack="true"></asp:DropDownList>
        <br /><br />
        ...
        <HeaderStyle  CssClass="GridViewHeaderStyle" />
          <Columns>
             ...
             <asp:BoundField DataField="Employee" HeaderText="Employee Contribution" DataFormatString="{0:n5}"/>
             <asp:BoundField DataField="Employee" HeaderText="Employer Contribution" DataFormatString="{0:n5}"/>
