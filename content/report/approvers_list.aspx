<%@ Page Language="C#" AutoEventWireup="true" CodeFile="approvers_list.aspx.cs" EnableEventValidation="false" Inherits="content_report_approvers_list" MasterPageFile="~/content/MasterPageNew.master"%>
               ...
               <div id="HeaderDiv"></div>
                    <asp:GridView ID="grid_view" runat="server"  AutoGenerateColumns="False" CssClass="table table-striped table-bordered no-margin">
                        <Columns>
                            ...
                            <asp:BoundField DataField="herarchy" HeaderText="Herarchy"/>
                        </Columns>
                    </asp:GridView>
