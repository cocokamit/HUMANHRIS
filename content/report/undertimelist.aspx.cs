...
public partial class content_report_undertimelist : System.Web.UI.Page
{
    ...
    protected void disp()
    {
        DataTable dt = dbhelper.getdata("select top 20 a.id,c.idnumber,c.lastname+', '+c.firstname+' '+ c.middlename ename,e.company,f.branch,left(convert(varchar,a.date,101),10)date, " +
                                        ...
                                        "where b.id is not null and b.payroll_id is not null and a.tardyundertimehours >0  " +
