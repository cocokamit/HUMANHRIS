<%@ Page Language="C#" AutoEventWireup="true" CodeFile="overtimelist.aspx.cs" EnableEventValidation="false"  Inherits="content_report_overtimelist" MasterPageFile="~/content/MasterPageNew.master" %>
        ...
        $(".auto").autocomplete({
            source: function (request, response) {
                $.ajax({
                    ...
                    url: "content/report/monitoring/overtimelist.aspx/GetEmployee",
                    data: "{'term':'" + $(".auto").val() + "'}",
                    dataType: "json",
        ...
        <div class="x_panel">
            ...
            <asp:GridView ID="grid_view" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered">
                <Columns>
                    ...
                    <asp:BoundField DataField="otnhrs" HeaderText="Night Hours" />
