<%@ Page Language="C#" AutoEventWireup="true" CodeFile="undertimelist.aspx.cs" EnableEventValidation="false" Inherits="content_report_monitoring_undertimelist" MasterPageFile="~/content/MasterPageNew.master"%>
        ...
        <div class="x_panel">
            ...
            <asp:GridView ID="grid_view" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered">
                <Columns>
                    ...
                    <asp:BoundField DataField="dtunder" HeaderText="Time Out" />
