...
public partial class content_report_monitoring_undertimelist : System.Web.UI.Page
{
    ...
    protected void execute()
    {
        ...
        {
            DataTable dt = dbhelper.getdata("select a.Id,a.emp_id,convert(varchar,a.date_filed,101)sysdate,a.dtunder,a.reason,a.status," +
                "b.LastName+', '+b.FirstName employee, c.PayrollGroup from Tundertime a left join MEmployee b on a.emp_id=b.Id left join " +
                "MPayrollGroup c on c.Id=b.PayrollGroupId where b.LastName+', '+b.FirstName like'%" + txtemp.Text + "%' " +
        ...
        else
        {
            DataTable dt = dbhelper.getdata("select a.Id,a.emp_id,convert(varchar,a.date_filed,101)sysdate,a.dtunder,a.reason,a.status," +
                "b.LastName+', '+b.FirstName employee, c.PayrollGroup from Tundertime a left join MEmployee b on a.emp_id=b.Id left join " +
                "MPayrollGroup c on c.Id=b.PayrollGroupId where b.LastName+', '+b.FirstName like'%" + txtemp.Text + "%' and a.date_filed " +
                "between'" + txtfrom.Text + "' and '" + txtto.Text + "' order by a.date_filed desc");
            grid_view.DataSource = dt;
            grid_view.DataBind();
            alert.Visible = grid_view.Rows.Count == 0 ? true : false;
        }
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        string filename = "Undertime_Monitoring";
        Response.Clear();
