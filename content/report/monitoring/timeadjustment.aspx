<%@ Page Language="C#" AutoEventWireup="true" CodeFile="timeadjustment.aspx.cs" EnableEventValidation="false" Inherits="content_report_monitoring_timeadjustment" MasterPageFile="~/content/MasterPageNew.master"%>
        ...
        $(".auto").autocomplete({
            source: function (request, response) {
                $.ajax({
                    ...
                    url: "content/report/monitoring/timeadjustment.aspx/GetEmployee",
                    data: "{'term':'" + $(".auto").val() + "'}",
                    dataType: "json",
...
<div class="page-title">
    <div class="title_left hd-tl">
        <h3>Time Adjustment Monitoring</h3>
    </div>   
</div>
        ...
        <div class="x_panel">
            ...
            <asp:GridView ID="grid_view" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered">
                <Columns>
                    ...
                    <asp:BoundField DataField="note" HeaderText="Reason" />
