...
public partial class content_report_monitoring_timeadjustment : System.Web.UI.Page
{
    ...
    protected void execute()
    {
        ...
        {
            DataTable dt = dbhelper.getdata("select a.Id,a.EmployeeId,convert(varchar,a.Date,101)Date,convert(varchar,a.sysdate,101)sysdate," +
                "a.time_in,a.time_OUT,a.note,a.status,b.LastName+', '+b.FirstName employee,c.PayrollGroup from Tmanuallogline a left join " +
                "MEmployee b on a.EmployeeId=b.Id left join MPayrollGroup c on c.Id=b.PayrollGroupId where b.LastName+', '+b.FirstName " +
                "like '%" + txtemp.Text + "%' order by a.Date desc");
        ...
        else
        {
            DataTable dt = dbhelper.getdata("select a.Id,a.EmployeeId,convert(varchar,a.Date,101)Date,convert(varchar,a.sysdate,101)sysdate," +
                "a.time_in,a.time_OUT,a.note,a.status,b.LastName+', '+b.FirstName employee,c.PayrollGroup from Tmanuallogline a left join " +
                "MEmployee b on a.EmployeeId=b.Id left join MPayrollGroup c on c.Id=b.PayrollGroupId where b.LastName+', '+b.FirstName like" +
                " '%" + txtemp.Text + "%' and Date between '" + txtfrom.Text + "' and '" + txtto.Text + "' order by a.Date desc");
            grid_view.DataSource = dt;
            grid_view.DataBind();
            alert.Visible = grid_view.Rows.Count == 0 ? true : false;
        }
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        string filename = "TimeAdjustment_Monitoring";
        Response.Clear();
