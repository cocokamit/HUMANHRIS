<%@ Page Language="C#" AutoEventWireup="true" CodeFile="otmeal.aspx.cs" EnableEventValidation="false" Inherits="content_report_monitoring_otmeal" MasterPageFile="~/content/MasterPageNew.master"%>
        ...
        <div class="x_panel">
            ...
            <asp:GridView ID="grid_view" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered">
                <Columns>
                    ...
                    <asp:BoundField DataField="OTIn" HeaderText="Time In" />
                    <asp:BoundField DataField="OTOut" HeaderText="Time Out" />
