...
public partial class content_report_overtimelist : System.Web.UI.Page
{
    ...
    protected void execute()
    {
        if (txtfrom.Text == "" && txtto.Text == "")
        {
            DataTable dt = dbhelper.getdata("select a.Id,a.EmployeeId,convert(varchar,a.Date,101)Date,convert(varchar,a.sysdate,101)sysdate," +
                "a.time_in,a.time_out,a.OvertimeHours othrs,a.OvertimeNightHours otnhrs,a.overtimehoursapp otapphrs,a.overtimenighthoursapp " +
                "otappnhrs,a.Remarks,a.status,b.LastName+', '+b.FirstName employee, c.PayrollGroup from TOverTimeLine a left join MEmployee b" +
                " on a.EmployeeId=b.Id left join MPayrollGroup c on c.Id=b.PayrollGroupId where b.LastName+', '+b.FirstName like " +
                "'%" + txtemp.Text + "%' order by a.Date desc");
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        string filename = "Overtime_Monitoring";
        Response.Clear();
