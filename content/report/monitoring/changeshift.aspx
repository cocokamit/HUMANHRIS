<%@ Page Language="C#" AutoEventWireup="true" CodeFile="changeshift.aspx.cs" EnableEventValidation="false" Inherits="content_report_monitoring_changeshift" MasterPageFile="~/content/MasterPageNew.master"%>
        ...
        $(".auto").autocomplete({
            source: function (request, response) {
                $.ajax({
                    ...
                    url: "content/report/monitoring/changeshift.aspx/GetEmployee",
                    data: "{'term':'" + $(".auto").val() + "'}",
                    dataType: "json",
        ...
        <div class="x_panel">
            ...
            <asp:GridView ID="grid_view" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered">
                <Columns>
                    ...
                    <asp:BoundField DataField="date" HeaderText="Filed Date" />
                    <asp:BoundField DataField="aa" HeaderText="From" />
                    <asp:BoundField DataField="bb" HeaderText="To" />
                    <asp:BoundField DataField="remarks" HeaderText="Reason" />
                    <asp:BoundField DataField="status" HeaderText="Status" />
                    <asp:TemplateField HeaderText="Action">
                      <ItemTemplate>
                        <asp:LinkButton ID="lnkview" OnClick="viewapprovers" runat="server" CssClass="fa fa-info-circle border-right"></asp:LinkButton>
                        </ItemTemplate>
...
<div class="modal fade in" id="modal_approver" runat="server">
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <asp:GridView ID="grid_approver" runat="server" AutoGenerateColumns="false" EmptyDataText="For Approval Application." CssClass="table table-striped table-bordered">
              <Columns>
                <asp:BoundField DataField="date" HeaderText="Date" DataFormatString="{0:MM/dd/yyyy}"/>
                <asp:BoundField DataField="Fullname" HeaderText="Approver"/>
