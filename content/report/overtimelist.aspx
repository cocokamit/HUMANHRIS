<%@ Page Language="C#" AutoEventWireup="true" CodeFile="overtimelist.aspx.cs" Inherits="content_report_overtimelist" MasterPageFile="~/content/MasterPageNew.master" %>
 ...
 <div id="div_list" runat="server">
                                ...
                                <asp:GridView ID="grid_absent" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered">
                                    <Columns>
                                        ...
                                        <%--<asp:BoundField DataField="tardylatehours" HeaderText="Late Hours" />--%>
                                    </Columns>
                                </asp:GridView>
                            </div>
                            </div>
