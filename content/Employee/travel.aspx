...
<div class="box box-primary">
    <div class="box-body">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txt_sdate" AutoCompleteType="None" CssClass="datee form-control" runat="server"></asp:TextBox>
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
                    <label>Time In</label>
                    <asp:Label ID="lbl_itime" style=" color:Red;" runat="server" Text=""></asp:Label>
                    <asp:TextBox ID="txt_itime" CssClass="timepicker form-control" runat="server"></asp:TextBox>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    ...
                    <asp:Label ID="lbl_otime" style=" color:Red;" runat="server" Text=""></asp:Label>
                    <asp:TextBox ID="txt_otime" CssClass="timepicker form-control" runat="server"></asp:TextBox>
                </div>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <asp:GridView ID="grid_item" runat="server" ShowFooter="True" onrowdeleting="grid_item_RowDeleting" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-form no-margin">
                <Columns>
                    <asp:TemplateField ItemStyle-Width="15px" HeaderText="No."> 
                        ...
                        <FooterTemplate>             
                            <asp:LinkButton ID="btn" runat="server" OnClick="ButtonAdd_Click" ToolTip="Add"><i class="fa fa-plus-circle"></i></asp:LinkButton>
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Place of Visit">
                        <ItemTemplate>
                            ...
                            <asp:TextBox ID="txt_date" CssClass="form-control"  runat="server" style=" min-width:200px"></asp:TextBox> 
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:LinkButton ID="can" runat="server" CausesValidation="false" CommandName="Delete" ToolTip="Delete"><i class="fa fa-trash"></i></asp:LinkButton>
                        </ItemTemplate>
            ...
            <asp:SqlDataSource ID="sql_income" runat="server" ProviderName="System.Data.SqlClient"  SelectCommand="select * from time_adjustment">
            </asp:SqlDataSource>
