                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Remarks" HeaderText="Remarks"/>
                     <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            <a href="dtrdetails?&dtrid=<%# function.Encrypt(Eval("id").ToString(), true)%>" target="_new"  class="border-right" ><i class="fa fa-clipboard sm" title="Daily Monitoring"></i></a>
                            <a href="payrollsum?&dtrid=<%# function.Encrypt(Eval("id").ToString(), true)%>&pg=<%# function.Encrypt(Eval("pg").ToString(), true)%>&ds=<%# function.Encrypt(Eval("DateStart").ToString(), true)%>&de=<%# function.Encrypt(Eval("DateEnd").ToString(), true)%>&tar=0" target="_new"  class="border-right" ><i class="fa fa-file-text" title="DTR Summary"></i></a>
