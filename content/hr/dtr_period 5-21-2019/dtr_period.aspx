                ...
                <div id="grid_alert" runat="server" class="alert alert-default no-margin">
                 ...
                 <asp:GridView ID="grid_view" runat="server" OnRowDataBound="rowbound" AutoGenerateColumns="false" CssClass="table table-striped table-bordered no-margin">
                    <Columns>
                        ...
                        <asp:BoundField DataField="date_start" ItemStyle-CssClass="hide" HeaderStyle-CssClass="hide"/>
                        <asp:BoundField DataField="date_end" ItemStyle-CssClass="hide" HeaderStyle-CssClass="hide"/>
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <div class="box-body table-responsive">
                    ...
                    <div runat="server" id="converter">
                        <asp:LinkButton ID="lnk_excel" runat="server" ToolTip="EXCEL"  OnClick="ExportToExcel"  CssClass="glyphicon glyphicon-circle-arrow-lef" Font-Size="20px" style=" margin:3px"><i class="fa fa-file-excel-o"></i></asp:LinkButton>
                        <asp:Button ID="btn_upload" runat="server" OnClick="upload" Text="Upload" CssClass="btn btn-primary"/>
                    </div>
...
<div id="modal_upload" runat="server" class="modal fade in" >
    ...
    <div class="modal-content">
        ...
        <div class="box-footer pad">
          <asp:Button ID="Button2" runat="server" OnClick="process" Text="Upload" CssClass="btn btn-primary"/>
        </div>
    </div>
    </div>
</div>
