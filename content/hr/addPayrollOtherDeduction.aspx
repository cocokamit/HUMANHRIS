           ...
           <%-- <asp:Label ID="lbl_err1" runat="server" ForeColor="Red"></asp:Label>--%>
            ...
            <asp:GridView ID="grid_item" runat="server" EmptyDataText="No Data Found!" EmptyDataRowStyle-ForeColor="Red"  AutoGenerateColumns="False"  CssClass="table table-striped table-bordered table-input">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Amortization">
                        <ItemTemplate>
    ...
    <div class="col-md-3">
        <div class="x_panel">
            <ul class="input-form">
                <li>Payroll Group</li>
                <li>
                    <asp:DropDownList ID="ddl_payroll_group" runat="server" OnSelectedIndexChanged="clickpg" AutoPostBack="true">
                    </asp:DropDownList>
                </li>
                <li>Payroll Range</li>
                <li>
                    <asp:DropDownList ID="ddl_pr_range"  OnTextChanged="selectpg"  AutoPostBack="true"  runat="server" >
                    </asp:DropDownList>
                </li>
