<%@ Page Language="C#" AutoEventWireup="true" CodeFile="scdet.aspx.cs" Inherits="content_payroll_scdet" %>
       ...
       <div id="container" style="overflow: scroll; overflow-x: hidden;">
        ...
        <asp:GridView ID="grid_view" runat="server" AutoGenerateColumns="false" CssClass="Grid">
                    <Columns>
                        ...
                        <asp:BoundField DataField="sctrnid" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol"/>
                        <asp:BoundField DataField="employee" HeaderText="Employee"/>
                        <asp:BoundField DataField="department" HeaderText="Department"/>
                        <asp:BoundField DataField="position" HeaderText="Position"/>
                        <asp:BoundField DataField="manhr" HeaderText="No of Days"/>
                        <asp:BoundField DataField="grossamt" HeaderText="Amount"/>
