    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
         <div class="x-head">
            ...
            <asp:TextBox ID="txt_f" Height="35px" type="date" runat="server" placeholder="From"></asp:TextBox>
            <asp:TextBox ID="txt_t" Height="35px" type="date" runat="server" placeholder="To"></asp:TextBox>
