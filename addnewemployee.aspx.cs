...
public partial class addnewemployee : System.Web.UI.Page
{
    ...
    protected void kanakanaas(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (e.Row.Cells[2].Text == "&nbsp;")//SAPNumber
            {
                e.Row.Cells[2].BackColor = System.Drawing.Color.Red;
            }
            if (e.Row.Cells[3].Text == "&nbsp;")//Biometrics
            {
    ...
    protected void galamay(DataTable company)
    {
        ...
        {
            DataRow[] checkexists = dtrelegion.Select("Relegion='" + datarow["religion"] + "'");
            if (checkexists.Count() == 0)
            {
                dtrrelegion = dtrelegion.NewRow();
                dtrrelegion["Relegion"] = datarow["religion"];
                if (datarow["Religion"].ToString() == "")
                { }
                else
                {
        ...
        {
            DataRow[] check = dtempstatus.Select("Employeestatus='" + dtrempstat["Status"] + "'");
            if (check.Count() == 0)
            {
                dtrempstatus = dtempstatus.NewRow();
                dtrempstatus["Employeestatus"] = dtrempstat["status"];
                if (dtrempstat["Status"].ToString() == "")
                { }
                else
                {
    ...
    protected void loadtemplate(object sender, EventArgs e)
    {
        ...
        foreach (DataRow dr in dtcheck.Rows)
        {
            ...
            a._sapnumber = dr["SAPNumber"].ToString().Length > 0 ? dr["SAPNumber"].ToString() : "000-0000";
            a._biometricnumber = dr["Biometric"].ToString().Length > 0 ? dr["Biometric"].ToString() : "000-0000";
            a._firstname = dr["FirstName"].ToString().Length > 0 ? dr["FirstName"].ToString() : a._firstname;
            a._lastname = dr["LastName"].ToString().Length > 0 ? dr["LastName"].ToString() : a._lastname;
            ...
            a._placeofbirth = dr["BirthPlace"].ToString().Length > 0 ? dr["BirthPlace"].ToString() : "";
            ...
            a._phonenumber = dr["TelephoneNumber"].ToString().Length > 0 ? dr["TelephoneNumber"].ToString() : "000-0000";
            ...
            DataTable dt_relegion = dbhelper.getdata("select * from MReligion where Religion='" + dr["Religion"] + "'");
            ...
            a._datehired = dr["HireDate"].ToString().Length > 0 ? dr["HireDate"].ToString() : "";
            ...
            DataTable dt_divs = dbhelper.getdata("select * from MDivision where Division = '" + dr["BandLevel"] + "'");
            a._division = dt_divs.Rows.Count > 0 ? dt_divs.Rows[0]["Id"].ToString() : "3";
            DataTable dtdivision2 = dbhelper.getdata("select * from MDivision2 where Division2 = '" + dr["Level"] + "'");
            a._division2 = dtdivision2.Rows.Count > 0 ? dtdivision2.Rows[0]["Id"].ToString() : "0";
            DataTable dt_ples = dbhelper.getdata("select * from mempstatus_setup where status = '" + dr["Status"] + "'");
            ...
            DataTable dt_glaccount = dbhelper.getdata("select * from MAccount where AccountCode = '" + dr["Account"] + "'");
            ...
            a._payrollgroup = dt_payrollgrp.Rows.Count > 0 ? dt_payrollgrp.Rows[0]["Id"].ToString() : "8";
            ...
            DataTable dtlevel = dbhelper.getdata("select * from MLevel where Level = '" + dr["Level"] + "'");
            a._level = dtlevel.Rows.Count > 0 ? dtlevel.Rows[0]["Id"].ToString() : "1";
            ...
            a._ntaca = "0.00";
            a._ntnsd = "0.00";
            a._reportsto = dr["ReportsTo"].ToString().Length > 0 ? dr["ReportsTo"].ToString() : "";

            string val = bol.loadaddtemplate(a);
        }
    ...
    protected void rowupdate(object sender, EventArgs e)
    {
        ...
        string lname = (row.Cells[5].Controls[0] as TextBox).Text;
        string exname = (row.Cells[6].Controls[0] as TextBox).Text;
        string mname = (row.Cells[7].Controls[0] as TextBox).Text;
        string plcebrt = (row.Cells[8].Controls[0] as TextBox).Text;
        string zipcode = (row.Cells[9].Controls[0] as TextBox).Text;
        string bloodtype = (row.Cells[10].Controls[0] as TextBox).Text;
        string cnum = (row.Cells[11].Controls[0] as TextBox).Text;
        string ctizen = (row.Cells[12].Controls[0] as TextBox).Text;
        string civilstat = (row.Cells[13].Controls[0] as TextBox).Text;
        string gender = (row.Cells[14].Controls[0] as TextBox).Text;
        string sss = (row.Cells[15].Controls[0] as TextBox).Text;
        string hdmfnum = (row.Cells[16].Controls[0] as TextBox).Text;
        string phicnum = (row.Cells[17].Controls[0] as TextBox).Text;
        string tinum = (row.Cells[18].Controls[0] as TextBox).Text;
        string pnum = (row.Cells[19].Controls[0] as TextBox).Text;
        string addrss = (row.Cells[20].Controls[0] as TextBox).Text;
        string peradd = (row.Cells[21].Controls[0] as TextBox).Text;
        string releg = (row.Cells[22].Controls[0] as TextBox).Text;
        string hyt = (row.Cells[23].Controls[0] as TextBox).Text;
        string wyt = (row.Cells[24].Controls[0] as TextBox).Text;
        string branch = (row.Cells[25].Controls[0] as TextBox).Text;
        string dhired = (row.Cells[26].Controls[0] as TextBox).Text;
        string department = (row.Cells[27].Controls[0] as TextBox).Text;
        string taxcod = (row.Cells[28].Controls[0] as TextBox).Text;
        string blevel = (row.Cells[29].Controls[0] as TextBox).Text;
        string level = (row.Cells[30].Controls[0] as TextBox).Text;
        string employeestatus = (row.Cells[31].Controls[0] as TextBox).Text;
        string position = (row.Cells[32].Controls[0] as TextBox).Text;
        string coa = (row.Cells[33].Controls[0] as TextBox).Text;
        string company = (row.Cells[34].Controls[0] as TextBox).Text;
        string ead = (row.Cells[35].Controls[0] as TextBox).Text;
        string intorder = (row.Cells[36].Controls[0] as TextBox).Text;
        string monrate = (row.Cells[37].Controls[0] as TextBox).Text;
        string payrate = (row.Cells[38].Controls[0] as TextBox).Text;
        string dayrate = (row.Cells[39].Controls[0] as TextBox).Text;
        string hrrate = (row.Cells[40].Controls[0] as TextBox).Text;
        string pgroup = (row.Cells[41].Controls[0] as TextBox).Text;
        string payroltype = (row.Cells[42].Controls[0] as TextBox).Text;
        string role = (row.Cells[43].Controls[0] as TextBox).Text;
        string section = (row.Cells[44].Controls[0] as TextBox).Text;
        string shiftcode = (row.Cells[45].Controls[0] as TextBox).Text;


        DataTable dt = ViewState["test"] as DataTable;
        dt.Rows[row.RowIndex]["IdNumber"] = idnum;
        dt.Rows[row.RowIndex]["SAPNumber"] = sapnum;
        dt.Rows[row.RowIndex]["Biometric"] = bio;
        ...
        dt.Rows[row.RowIndex]["BirthPlace"] = plcebrt;
        dt.Rows[row.RowIndex]["ZipCode"] = zipcode;
        ...
        dt.Rows[row.RowIndex]["Role"] = role;
