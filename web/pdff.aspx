<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pdff.aspx.cs" Inherits="web_pdff" %>
...
<html dir="ltr" mozdisallowselectionprint=""><head>
    ...
    <title>2316aug2008v3.xls - compressed.tracemonkey-pldi-09.pdf</title>
    ...
    <div id="outerContainer">
      ...
      <div id="sidebarContainer">
        ...
        <div id="sidebarContent">
          <div id="thumbnailView"><a href="#page=1" title="Page 1"><div class="thumbnail selected" data-page-number="1"><div class="thumbnailSelectionRing" style="width: 100px; height: 163px;"></div></div></a></div>
      ...
      <div id="mainContainer">
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
          <div id="secondaryToolbarButtonContainer">
            ...
            <a href="#page=1&amp;zoom=auto,-15,1015" id="secondaryViewBookmark" class="secondaryToolbarButton bookmark visibleSmallView" title="Current view (copy or open in new window)" tabindex="55" data-l10n-id="bookmark">
            ...
            <button id="lastPage" class="secondaryToolbarButton lastPage" title="Go to Last Page" tabindex="57" data-l10n-id="last_page" disabled="">
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              <div id="toolbarViewerLeft">
                ...
                <input type="number" id="pageNumber" class="toolbarField pageNumber" title="Page" value="1" size="4" min="1" tabindex="15" data-l10n-id="page" max="1">
              ...
              <div id="toolbarViewerRight">
                ...
                <a href="#page=1&amp;zoom=auto,-15,1015" id="viewBookmark" class="toolbarButton bookmark hiddenSmallView" title="Current view (copy or open in new window)" tabindex="35" data-l10n-id="bookmark">
                  <span data-l10n-id="bookmark_label">Current View</span>
                </a>
