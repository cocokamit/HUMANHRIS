<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addtemplate.aspx.cs" Inherits="addtemplate"%>
    ...
    <br />
        ...
        <asp:GridView ID="GridView1" Visible="false" runat="server"  AutoGenerateColumns="false" OnRowEditing="rowediting" OnRowDeleting="rowdeleterow" CssClass="table table-striped table-bordered" OnRowDataBound="kanakanaas">
            <Columns>
                ...
                <asp:BoundField DataField="PlaceOfBirth" HeaderText="Birthplace" />
                <asp:BoundField DataField="DateHired" HeaderText="DareHired" />
                ...
                <asp:BoundField DataField="Relegion" HeaderText="Relegion" />
                <asp:BoundField DataField="Height" HeaderText="Height" />
                <asp:BoundField DataField="Weight" HeaderText="Weight" />
                <asp:BoundField DataField="BloodType" HeaderText="Blood_Type" />
                <asp:BoundField DataField="GSISNumber" HeaderText="GSISNumber" />
                ...
                <asp:BoundField DataField="Accountnumber" HeaderText="ATMAccountNumber" />
                <asp:BoundField DataField="Company" HeaderText="Company" />
                <asp:BoundField DataField="Branch" HeaderText="Branch" />
                <asp:BoundField DataField="Department" HeaderText="Department" />
                <asp:BoundField DataField="Section" HeaderText="Section" />
                <asp:BoundField DataField="Position" HeaderText="Position" />
                <asp:BoundField DataField="Division/BandLevel" HeaderText="Band Level" />
                ...
                <asp:BoundField DataField="FixNoofDays" HeaderText="FixNoofDays" />
                <asp:BoundField DataField="FixNoofHours" HeaderText="FixNoofHours" />
                ...
                <asp:BoundField DataField="NTI" HeaderText="NTI" />
                <asp:BoundField DataField="Tax-table" HeaderText="TaxTable" />
                <asp:BoundField DataField="Employeestatus" HeaderText="EmployeeStatus" />
